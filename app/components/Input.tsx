...
import {Text, TextInput, TextInputProps, View, StyleSheet, TouchableOpacity, Image } from "react-native";
      ...
      <View style={[styles.inputContainer,{ backgroundColor:colors.bgInput,borderColor:colors.border}]}>
        ...
        {secureTextEntry && (
          <TouchableOpacity style={styles.eyeButton} onPress={togglePasswordVisibility}>
            <Image
              source={isPasswordVisible ? require("@/assets/images/design/eye.png") : require("@/assets/images/design/eye-crossed.png")}
              style={[styles.eyeIcon,{tintColor:colors.police}]}
            />
          </TouchableOpacity>
        )}
      </View>
